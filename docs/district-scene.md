...
- **Cost.** Up to three texture samples per present layer, eight texture units in all, and no extra draws or triangles: the district still opens at 38 asset draws and 71,571 triangles.
